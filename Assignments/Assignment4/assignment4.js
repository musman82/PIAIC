...
let varCaseString = "Usman";
console.log("Question # 3 Output");
console.log("Lower Case: ", varCaseString.toLowerCase());
console.log("Upper Case: ", varCaseString.toUpperCase());
console.log("Title Case: ", varCaseString[0].toUpperCase() + varCaseString.slice(1).toLowerCase());
...
let message = "The biggest shame is to mock at something that you have in yourself.";
...
let varStrippingName = "\t\n Usman \n\t";
console.log("Name with whitespaces : ", varStrippingName);
console.log("Name without whitespaces : ", varStrippingName.trim());
...
let varAddition = 5 + 3;
let varSubtraction = 10 - 2;
let varMultiplication = 4 * 2;
let varDivision = 16 / 2;
console.log("Question # 7 Output");
console.log("Addition 5 + 3 = ", varAddition);
console.log("Subtraction 10 - 2 = ", varSubtraction);
console.log("Multiplication 4 * 2 = ", varMultiplication);
console.log("Division 16 / 2 = ", varDivision);
...
let varFavoriteNumber = 42;
let varMessage = `My favorite number is ${varFavoriteNumber}.`;
...
console.log("Title Case : ", varCaseString1[0].toUpperCase() + varCaseString1.slice(1).toLowerCase()); // Result: Usman
// Name: Muhammad Usman
// Date: 19-07-2023
...
let arrNames = ["Muhamamd", "Usman", "Rasheed", "Hassan"];
...
let arrNames1 = ["Muhamamd", "Usman", "Rasheed", "Hassan"];
...
let cars = ["Toyota", "Honda", "BMW", "Tesla"];
...
let arrGuests = ["Muhammad", "Usman", "Rasheed", "Hassan"];
...
let arrGuests1 = ["Muhammad", "Usman", "Rasheed", "Hassan"];
...
let arrGuests2 = ["Muhammad", "Usman", "Rasheed", "Hassan"];
...
let arrGuests3 = ["Muhammad", "Usman", "Rasheed", "Hassan"];
...
let varItemsToRemove = arrGuests3.length - 2;
...
let arrPlaces = ["Lahore", "Karachi", "Peshawar", "Quetta", "Faisalabad"];
...
let arrGuests4 = ["Muhammad", "Usman", "Rasheed", "Hassan"];
...
let arrCountries = ["Amarica", "Brazil", "France", "China", "UAE", "Pakistan"];
...
let great_magicians = make_great2([...arrMagicians2]);
