...
let result1 = array1.map((value) => value * 2);
...
let array2 = ["apple", "banana", "cherry", "date", "grape"];
...
let result3 = array3.filter((value) => {
    if (value % 2 === 0) {
        return true;
    }
...
let array4 = [0, 10, 20, 30, 40];
let result4 = array4.map((value) => ((value * 9) / 5) + 32);
...
let array5 = [3, 6, 9, 12, 15, 18];
let result5 = array5.filter((value) => {
    if (value % 2 !== 0) {
        return true;
    }
}).map((value) => value * 2);
...
let array6 = ["Alice", "Bob", "Charlie", "David", "Emily"];
